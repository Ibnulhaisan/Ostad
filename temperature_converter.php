...
<br><br>
<input type="submit" name= "submit" value="Convert" style="font-size: 2em; background-color:  #4c4c4c;">
<!-- <input type="reset" value="Reset" style="font-size: 2em; background-color: #1c1c1c;"> -->
 </center>
